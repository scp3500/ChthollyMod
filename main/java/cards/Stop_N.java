...
public class Stop_N extends CustomCard {
    ...
    public Stop_N() {
        super(ID, cardStrings.NAME, "img/cards_Seles/Stop_N.png", 2, cardStrings.DESCRIPTION, CardType.ATTACK, AbstractCardEnum.Chtho_COLOR, CardRarity.UNCOMMON, CardTarget.ENEMY);
        this.baseDamage = 16;
    }
