...
public class Illusion_BodyAction extends AbstractGameAction {
    ...
    public Illusion_BodyAction(AbstractCreature source, int amount) {
    ...
    private boolean isIllusion_Bodyable(AbstractCard card) {
