...
public class Sage_N extends CustomCard {
    ...
    public Sage_N() {
        super(ID, cardStrings.NAME, "img/cards_Seles/Sage_N.png", 1, cardStrings.DESCRIPTION, CardType.SKILL, AbstractCardEnum.Chtho_COLOR, CardRarity.UNCOMMON, CardTarget.SELF);
