...
public class Emergency_Cooking extends CustomCard {
    ...
    public Emergency_Cooking() {
        super(ID, cardStrings.NAME, "img/cards_Seles/Emergency_Cooking.png", 0, cardStrings.DESCRIPTION, CardType.SKILL, AbstractCardEnum.Chtho_COLOR, CardRarity.COMMON, CardTarget.SELF);
