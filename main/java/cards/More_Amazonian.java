...
public class More_Amazonian extends CustomCard {
    ...
    public More_Amazonian() {
        super(ID, cardStrings.NAME, "img/cards_Seles/More_Amazonian.png", 2, cardStrings.DESCRIPTION, CardType.ATTACK, AbstractCardEnum.Seles_COLOR, CardRarity.UNCOMMON, CardTarget.ENEMY);
        this.baseDamage = 5;
