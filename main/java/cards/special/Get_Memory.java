...
public class Get_Memory extends CustomCard {
    public static final String ID = "Get_Memory";
    private static final CardStrings cardStrings;
    public static final int NUM1 = 4;
    public static final int NUM2 = 8;

    public Get_Memory() {
        super("Get_Memory", cardStrings.NAME, "img/cards_Seles/Get_Memory.png", -2, cardStrings.DESCRIPTION, CardType.STATUS, CardColor.COLORLESS, CardRarity.COMMON, CardTarget.NONE);
    }
    ...
    public AbstractCard makeCopy() {
        return new Get_Memory();
    }

    static {
        cardStrings = CardCrawlGame.languagePack.getCardStrings("Get_Memory");
    }
}
