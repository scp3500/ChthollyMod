...
public class Selfless_N extends CustomCard {
    ...
    public Selfless_N() {
        super(ID, cardStrings.NAME, "img/cards_Seles/Selfless_N.png", 3, cardStrings.DESCRIPTION, CardType.ATTACK, AbstractCardEnum.Chtho_COLOR, CardRarity.RARE, CardTarget.ALL_ENEMY);
        this.baseDamage = 5;
