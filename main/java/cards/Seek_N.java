...
public class Seek_N extends CustomCard {
    ...
    public Seek_N() {
        super(ID, cardStrings.NAME, "img/cards_Seles/Seek_N.png", 1, cardStrings.DESCRIPTION, CardType.SKILL, AbstractCardEnum.Seles_COLOR, CardRarity.COMMON, CardTarget.SELF);
