...
public class Confidence_N extends CustomCard {
    ...
    public Confidence_N() {
        super(ID, cardStrings.NAME, "img/cards_Seles/Confidence_N.png", 0, cardStrings.DESCRIPTION, CardType.SKILL, AbstractCardEnum.Seles_COLOR, CardRarity.UNCOMMON, CardTarget.SELF);
        this.baseBlock = 4;
    }
