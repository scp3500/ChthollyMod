...
public class Recall_N extends CustomCard {
    ...
    public Recall_N() {
        super(ID, cardStrings.NAME, "img/cards_Seles/Recall_N.png", 1, cardStrings.DESCRIPTION, CardType.SKILL, AbstractCardEnum.Chtho_COLOR, CardRarity.UNCOMMON, CardTarget.SELF);
