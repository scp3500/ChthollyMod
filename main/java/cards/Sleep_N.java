...
public class Sleep_N extends CustomCard {
    ...
    public Sleep_N() {
        super(ID, cardStrings.NAME, "img/cards_Seles/Sleep_N.png", 1, cardStrings.DESCRIPTION, CardType.SKILL, AbstractCardEnum.Seles_COLOR, CardRarity.UNCOMMON, CardTarget.SELF);
