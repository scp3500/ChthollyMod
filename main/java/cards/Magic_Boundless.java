...
public class Magic_Boundless extends CustomCard {
    ...
    public Magic_Boundless() {
        super(ID, cardStrings.NAME, "img/cards_Seles/Magic_Boundless.png", 1, cardStrings.DESCRIPTION, CardType.ATTACK, AbstractCardEnum.Seles_COLOR, CardRarity.UNCOMMON, CardTarget.SELF_AND_ENEMY);
        this.baseDamage = 5;
