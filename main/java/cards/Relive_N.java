...
public class Relive_N extends CustomCard {
    ...
    public Relive_N() {
        super(ID, cardStrings.NAME, "img/cards_Seles/Relive_N.png", 1, cardStrings.DESCRIPTION, CardType.SKILL, AbstractCardEnum.Chtho_COLOR, CardRarity.RARE, CardTarget.SELF);
