...
public class On_Rush extends CustomCard {
    ...
    public On_Rush() {
        super(ID, cardStrings.NAME, "img/cards_Seles/On_Rush.png", 0, cardStrings.DESCRIPTION, CardType.SKILL, AbstractCardEnum.Chtho_COLOR, CardRarity.COMMON, CardTarget.SELF);
